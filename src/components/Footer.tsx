        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/people/Western-Educonnect/pfbid0HJjzxUwjQ8r337HvQi6pz2EnCPkxWdE8coT6GTzgbWHZYrcxwJk2RLRxaRcHTT6Cl/?ref=ig_profile_ac" className="text-gray-400 hover:text-white transition">
              ...
              <a href="https://www.instagram.com/western_educonnect/" className="text-gray-400 hover:text-white transition">
